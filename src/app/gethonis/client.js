	...
	return (
		...
		<div className={` ${init === false ? "" : "bottom-0 fixed mb-10"} w-full absolute left-0 flex justify-center`}>
			...
			<form onSubmit={(e) => { 
				...
				<div ref={chatContainerRef} className={` ${init === false ? "hidden" : "block"} text-white mt-[20%] sm:mt-[10%] p-5 w-[100%] lg:w-[50%] sm:w-[80%] sm:p-10 overflow-scroll rounded-lg no-scrollbar `}>
					{chat.map((c, i) => (
