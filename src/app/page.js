  ...
  return (
    <section className="bg-black-600 w-full h-screen content-center">
      <div className="w-full h-auto flex justify-center">
        <div className="w-auto  sm:rounded-lg shadow-gray sm:shadow-sm/10 sm:px-10 sm:pt-30 sm:pb-10">
      ...
      {type ? (
            ...
            <button className="text-[14px] text-red-200 p-2 w-70" onClick={changeType}>{type ? ("You don't have an account? register here") : ("You already posses an account? login here")}</button>
          </div>
        </div>
      </div>
    </section>
