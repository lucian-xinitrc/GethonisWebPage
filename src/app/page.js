  ...
  return (
    <section className="bg-black w-full h-screen content-center">
      <div className="w-full h-auto flex justify-center">
        <div className="w-auto border border-solid border-white/[.145] rounded-lg shadow-white shadow-md/10 px-5 py-10 pt-30 pb-20">
        ...
        <h1 className="text-[#1793d1] font-bold pt-2 pl-2 text-2xl font-monospace">Gethonis</h1>
            ...
            <form onSubmit={handleLogin}>
              <input 
                ...
                className="mt-8 rounded-lg shadow-white shadow-md/10 border shadow-white border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center transition duration-700 ease-in-out font-bold text-sm sm:text-base h-10 p-2 px-5 w-full mr-2 sm:text-[15px] focus:outline-none"
              />
              <input 
                type="password"
                ...
                className="mt-5 rounded-lg shadow-white shadow-md/10 border shadow-white border-solid border-black/[.08] dark:border-white/[.145] transition-colors flex items-center justify-center transition duration-700 ease-in-out font-bold text-sm sm:text-base h-10 p-2 px-5 w-full mr-2 sm:text-[15px] focus:outline-none"
              />
